...
class Print_Array_uc_1 {
    public static void toPrint(Integer[] integer){
        for (Integer e:integer
             ) {
    ...
    public static class Print_The_Array {
        ...
        public static void main(String[] args) {
           ...
           Character[] Chc ={'s','d','g'};
          Print_Array_uc_1.toPrint(Int);
          Print_Array_uc_1.toPrint(Dble);
          Print_Array_uc_1.toprint(Chc);
        }
    }
}
